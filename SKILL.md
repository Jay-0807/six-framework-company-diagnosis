...
11. **每节必须嵌入对应的标准可视化**（见 visualization-templates.md）：
    - PEST → 强度可视化（条形 / 表格）
...
| 每个框架的标准可视化 Mermaid 模板 | visualization-templates.md |
...
- 任一节缺"框架解释" → **补**(铁律 10)
- 任一节缺对应的标准可视化(Mermaid / Heatmap / 决策树)→ **补**(铁律 11;见 visualization-templates.md)
